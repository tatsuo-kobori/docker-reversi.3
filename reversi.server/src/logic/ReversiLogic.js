...
exports.searchPlaceToPut = exports.searchBoard = void 0;
function searchBoard(boardInfo, position, direction, color, searchResult, simulate) {
...
function searchPlaceToPut(boardInfo) {
...
exports.searchPlaceToPut = searchPlaceToPut;
